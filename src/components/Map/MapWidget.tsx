...
type MapWidgetProps =
    ...
    | { mode: "route"; events: TripEvent[]; startDate: Date; endDate: Date };
    ...
    if (props.mode === "place") {
        ...
        return (
            <div className="flex flex-col rounded-2xl overflow-hidden shadow-md bg-white border-b-4 border-red-400">
                <div className="h-64 md:h-96 lg:h-112 w-full">
                ...
                <div className="flex flex-col rounded-2xl overflow-hidden shadow-md bg-white border-b-4 border-red-400">
                    ...
                    <div className="w-full p-4 flex flex-col gap-4">
                        ...
                        <ScrollContainer
                            ...
                            hideScrollbars={true}
                        >
                            <div className="flex justify-start gap-2 px-1 py-1 whitespace-nowrap">
                                <MapDayButton
